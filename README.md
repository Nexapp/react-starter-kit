## A note from Nexapp
We forked [React Starter Kit](https://github.com/kriasoft/react-starter-kit) and customized it to implement the most used tools instead
* [react-router](https://github.com/reactjs/react-router) instead of [universal-router](https://github.com/kriasoft/universal-router)
